...
input_bad_environment = {
    ...
    "iamPolicyMembers": {
        "usersByEmail": {
            "user@doms.com": {"roles": [ "editor", "viewer"] }
        }
    }
}
...
input_role_is_not_listed = {
    ...
    "iamPolicyMembers": {
        "usersByEmail": {
            "user@doms.com": {"roles": [ "editor", "viewer", "admin"] }
        }
    }
}
...
input_role_not_allowed_for_group_not_listed = {
    ...
    "iamPolicyMembers": {
        "groupsByEmail": {
            "group@doms.com": {"roles": [ "adminOfUniverse" ] }
        }
    }
}
...
input_user_allowed_group_not_allowed_not_listed = {
    ...
    "iamPolicyMembers": {
        "usersByEmail": {
            "user@doms.com": {"roles": [ "adminOfUniverse" ] }
        },
        "groupsByEmail": {
            "group@doms.com": {"roles": [ "adminOfUniverse" ] }
        }
...
input_user_allowed_service_accounts_not_allowed_not_listed = {
    ...
    "iamPolicyMembers": {
        "serviceAccountsByEmail": {
            "serviceaccount@doms.com": {"roles": [ "iam.serviceAccountOfUniverse" ] }
        }
    }
}
...
input_allowed_allowedForGroups = {
    ...
    "iamPolicyMembers": {
        "groupsByEmail": {
            "group@doms.com": {"roles": [ "bigquery.admin" ] } # Allowed for Groups
        }
    }
}
input_not_allowed_allowedForGroups = {
    ...
    "iamPolicyMembers": {
        "groupsByEmail": {
            "group@doms.com": {"roles": [ "bigquerydatatransfer.serviceAgent" ] } # Not Allowed for Groups
        }
    }
}
input_allowed_allowedForServiceAccounts = {
    ...
    "iamPolicyMembers": {
        "ServiceaccountsByEmail": {
            "serviceaccount@doms.com": {"roles": [ "bigquerydatatransfer.serviceAgent" ] } # Allowed for Service Accounts
        }
    }
}
input_not_allowed_allowedForServiceAccounts = {
    ...
    "iamPolicyMembers": {
        "serviceAccountsByEmail": {
            "serviceaccount@doms.com": {"roles": [ "iam.serviceAccountKeyAdmin" ] } # Not Allowed for Service Accounts
        }
    }
}
input_not_allowed_allowedForUsers = {
    ...
    "iamPolicyMembers": {
        "usersByEmail": {
            "user@doms.com": {"roles": [ "bigquery.admin"] } # Not Allowed for Users
        }
    }
}
...
input_not_allowed_prd_allowedForGroups = {
    ...
    "iamPolicyMembers": {
        "groupsByEmail": {
            "group@doms.com": {"roles": [ "storage.admin" ] } # Not Allowed for Groups for prd, but is in lle.
        }
    }
}
input_allowed_nonprd_allowedForGroups = {
    ...
    "iamPolicyMembers": {
        "groupsByEmail": {
            "group@doms.com": {"roles": [ "storage.admin" ] } # Not Allowed for Groups for prd, but is in othere.
        }
    }
}
...
input_not_allowed_prd_allowedForServiceAccounts = {
    ...
    "iamPolicyMembers": {
        "serviceAccountsByEmail": {
            "serviceaccount@doms.com": {"roles": [ "compute.osLogin" ] } # Not Allowed for Service Accounts for prd, but is in others.
        }
    }
}
...
input_allowed_sbx_allowedForGroups = {
    ...
    "iamPolicyMembers": {
        "groupsByEmail": {
            "group@doms.com": {"roles": [ "sourcerepo.serviceAgent" ] } # Allowed for Groups for sbx, but is in other.
        }
    }
}
...
input_not_allowed_nonsbx_allowedForGroups = {
    ...
    "iamPolicyMembers": {
        "groupsByEmail": {
            "group@doms.com": {"roles": [ "sourcerepo.serviceAgent" ] } # Allowed for Groups for sbx, but is not in other.
        }
    }
}
...
input_allowed_sbx_allowedForServiceAccounts = {
    ...
    "iamPolicyMembers": {
        "serviceAccountsByEmail": {
            "serviceaccount@doms.com": {"roles": [ "iam.serviceAccountTokenCreator" ] } # Allowed for Service Accounts for sbx, but is not in other.
        }
    }
}
...
input_allowed_sbx_allowedForUsers = {
    ...
    "iamPolicyMembers": {
        "usersByEmail": {
            "user@doms.com": {"roles": [ "compute.imageUser"] } # Allowed for Users for sbx, but is not in other.
        }
    }
}
...
input_allowed_by_project = {
    "project": {
        ...
        "name": "doms-platform-dbaas-ops"
    },
    "iamPolicyMembers": {
        "serviceAccountsByEmail": {
            "serviceaccount@doms.com": {"roles": [ "iap.tunnelResourceAccessor", "storage.hmacKeyAdmin" ] }
        },
        "groupsByEmail": {
            "group@doms.com": {"roles": [ "cloudsql.client" ] }
        }
    }
}
