        ...
        stages {
            stage('Analyzing Go source code') {
                steps {
                    ...
                    // * 10.0.0.0/8    - all doms internal IP address space
                    ...
                    // * ::            - IPv6 localhost
                    // * *.doms.com   - Include any internal Kohl's DNS names
                    //
                    // See https://godoc.org/golang.org/x/net/http/httpproxy for info abot Go Lang
                    // NO_PROXY environment variable usage.
                    sh("""
                    unset no_proxy
                    export NO_PROXY="127.0.0.1,10.0.0.0/8,100.64.0.0/10,172.16.0.0/12,::,*.doms.com"
