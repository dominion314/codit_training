...
def call(String opaRepo, String opaPolicyFolder, String localOpaConfig) {
    pipeline {
        ...
        environment {
            HTTP_PROXY="http://proxy-gcp-central.commonmerit.com:8080"
            HTTPS_PROXY="http://proxy-gcp-central.commonmerit.com:8080"
            http_proxy="http://proxy-gcp-central.commonmerit.com:8080"
            https_proxy="http://proxy-gcp-central.commonmerit.com:8080"
        }
        ...
        stages {
            ...
            stage('Locate OPA binary and prepare environment') {
                steps {
                    ...
                    curl -L -o /tmp/opa/opa.tgz https://cicd-nexus.commonmerit.com:8443/nexus/service/local/repositories/cmfc-nexus-thirdparty/content/com/commonmerit/infrastructure/open-policy-agent/0.17.3/open-policy-agent-0.17.3.tar.gz
