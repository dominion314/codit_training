package commonmerit.gitops.kcc.gcp_project.custom.iam.roles
...
input_allowed_per_projects = {
    "project": {
        ...
        "name": "commonmerit-cpe-e2edemo-lle"
    },
    "iamPolicyMembersV2": {
        "usersByEmail": {
            "user@commonmerit.com": [
                {
                    "role": "editor" #Only allowed for commonmerit-cpe-e2edemo-lle
                }
            ]
        }
    }
