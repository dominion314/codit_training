...
#     Run gcloud projects get-iam-policy commonmerit-cpe-cpa-lle --format yaml > iam-bindings.yml
#     where you replace commonmerit-cpe-cpa-lle with the project that you want to export iam bindings from.
