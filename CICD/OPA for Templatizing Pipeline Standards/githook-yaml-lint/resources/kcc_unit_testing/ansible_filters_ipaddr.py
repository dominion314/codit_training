# pylint: skip-file
# .............................................................................................
# This code is part of ansible code base
# https://github.com/ansible/ansible.git checked out at 953aa26286db433c3509785e24f89f6616233841 (July 24th 2020)
#
# This portion covers implementation of ipaddr filter for jinja
#..............................................................................................
...
def _first_usable_query(v, vtype):
    if vtype == "address":
        ...
        raise BaseException("Not a network address")
    elif vtype == "network":
        if v.size == 2:
...
def _peer_query(v, vtype):
    if vtype == "address":
        ...
        raise BaseException("Not a point-to-point network")
...
def next_nth_usable(value, offset):
    ...
    if type(offset) != int:
        ...
        raise BaseException("Must pass in an integer")
    if v.size > 1:
        first_usable, last_usable = _first_last(v)
